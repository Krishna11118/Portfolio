      ...
      {visibleProjects < projects.length && (
        ...
        >
          <button
            ...
            className="inline-flex items-center justify-center bg-gradient-to-r from-blue-600 to-blue-300 hover:from-blue-700 hover:to-blue-300 text-white px-6 py-3 rounded-lg shadow-lg transition-all duration-300 text-sm font-medium"
          >
            View More
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                ...
                <div className="flex flex-col md:flex-row gap-3 mt-4 md:mt-0">
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center bg-gradient-to-r from-blue-600 to-blue-300 hover:from-blue-700 hover:to-blue-300 text-white px-4 py-2 rounded-lg shadow-lg transition-all duration-300 text-sm"
                  >
              ...
              <div className="flex border-b border-gray-800 mb-6">
                ...
                >
                  ...
                  {activeTab === "overview" && (
                    <motion.div
                      layoutId="activeTab"
                      className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-500 to-white"
                    />
                  )}
                </button>
                <button
