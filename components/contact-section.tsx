...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-12 sm:py-16 overflow-hidden">
      <Spotlight className="hidden sm:block" fill="blue" />
      <div className="container px-4 sm:px-6 md:px-8 max-w-4xl mx-auto relative z-10">
        <motion.div
        ...
        >
          <form
            ...
            className="bg-gray-900/80 backdrop-blur-sm p-4 sm:p-6 rounded-lg border border-gray-800"
          >
            <h3 className="text-lg sm:text-xl font-semibold mb-5 text-white">Send Me a Message</h3>
            ...
            <div className="mt-6">
              {/* <h4 className="text-white font-medium mb-4 text-sm sm:text-base text-center">
                Connect with me
              </h4> */}
              <div className="flex justify-center space-x-4">
                <a
                  href="https://www.linkedin.com/in/krishna365/"
              ...
              <div className="mt-4 flex justify-center items-center space-x-2">
                <span className="text-white text-base sm:text-base">krishnasss365@gmail.com</span>
                <button
                  type="button"
