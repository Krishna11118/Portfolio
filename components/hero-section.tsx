    ...
    <div className="flex min-h-screen items-center justify-center">
      <LampContainer>
        <motion.h1
          ...
          className="bg-gradient-to-br mt-8 from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
        >
