  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 px-4 sm:x-40 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
