...
export const LampContainer = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex w-full h-1/2 items-center justify-center isolate z-0">
        <motion.div
      ...
      {/* Content container */}
      <div className="relative z-50 flex flex-col items-center justify-center px-5 h-1/2">
        {children}
      </div>
    </div>
  );
