  ...
  return (
    <div className={cn("sticky top-20", className)}>
      <p className="text-lg md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300">
        Hi, I'm <span className="text-primary">Krishna</span>
      </p>
      <p className="text-xs sm:text-sm md:text-lg lg:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto px-4 sm:px-6">
        I help companies automate their systems and create innovative web
        solutions, delivering tailored digital experiences that drive business
        growth.
      </p>
      <div className="w-full h-[890px] -top-60 md:-top-40 flex items-center justify-center bg-red-transparent absolute ">
        <div className="flex items-center space-x-1">
          {" "}
          {/* Flex container to group buttons */}
          <button className="font-bold bg-white rounded-full lg:mt-32 md:mt-24 mt-8 md:px-4 md:py-2 px-2 py-1 z-30 lg:text-lg md:text-base text-black text-xs w-fit mx-auto">
            <Link href="https://github.com/krishna11118" target="_blank">
          ...
          <button className="font-bold bg-white rounded-full lg:mt-32 md:mt-24 mt-8 md:px-4 md:py-2 px-2 py-1 z-30 lg:text-lg md:text-base text-black text-xs w-fit mx-auto">
            <a href="mailto:krishnasss365@gmail.com">
